...
if (
    ...
    if (
        ...
        $billetC->updateBillet($billet, $_POST['idBillet']);
...
<body>
    ...
    if (isset($_POST['idBillet'])) {
        $billet = $billetC->showBillet($_POST['idBillet']);
...
<div class="template-container"> <!-- Add this container div -->
    <div id="form-container">
        <form action="" method="POST">
            <table>
            <tr>
                    <td><label for="idBillet">id Ticket :</label></td>
                    <td>
                        <input type="hidden" id="idBillet" name="idBillet" value="<?php echo $billet['idBillet']; ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="flightNumber" onkeyup="validerFn()" name="flightNumber" value="<?php echo $billet['flightNumber']?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="UserName" onkeyup="validerUs()" name="UserName" value="<?php echo $billet['UserName'] ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" id="Date_Purchase" name="Date_Purchase" value="<?php echo $billet['Date_Purchase'] ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="Seat_Number" onkeyup="validerSeat_Number()" name="Seat_Number" value="<?php echo $billet['Seat_Number'] ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="Price" onkeyup="validerPrice()" name="Price" value="<?php echo $billet['Price'] ?>"/>
