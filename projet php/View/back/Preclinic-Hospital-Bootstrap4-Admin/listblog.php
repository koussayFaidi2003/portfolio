...
<div class="row">
    <div class="col-sm-8 col-9 text-right m-b-20" style="float: right;">
        <a style="margin-top: 40px; margin-right: 150px;" href="addblog.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Blog</a>
    </div>  
</div>
